...
void BOARD_InitPins(void)
{
    ...
    CLOCK_EnableClock(kCLOCK_PortE); // PORT E for the UART

    PORT_SetPinMux(PORTC, 1U, kPORT_MuxAlt4);
    PORT_SetPinMux(PORTA, 6U, kPORT_MuxAlt3);

    //set the pin MUX for UART4_TX, UART4_RX, UART4_CTS_B, and UART4_RTS_B
    PORT_SetPinMux(PORTC, 13U, kPORT_MuxAlt3); //UART4_TX
    PORT_SetPinMux(PORTC, 14U, kPORT_MuxAlt3); //UART4_RX
    PORT_SetPinMux(PORTC, 15U, kPORT_MuxAlt3); //UART4_CTS_B
    PORT_SetPinMux(PORTE, 27U, kPORT_MuxAlt3); //UART4_RTS_B
